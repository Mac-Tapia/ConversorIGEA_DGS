...
- [ ] Write failing tests for 96 feeders, 96 sources, 38,657 sections, load-table joins, switch/sectionalizer retention and IN111 resolution by short name.
...
- [ ] Run the full 96-feeder strict audit and record success/failure per feeder without fallback substitutions.
